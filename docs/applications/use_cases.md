...
This page is the biology- and translational-impact narrative for
Agentic-SpliceAI. For the application ledger (what currently exists,
maturity, driving examples), see [README.md](README.md).

The content below was the original `docs/applications/README.md`
(April 2026) and is preserved here verbatim as the translational-pathway
reference.
