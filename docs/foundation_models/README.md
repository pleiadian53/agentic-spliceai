...
| [remote_training_options.md](../compute/remote_training_options.md) | Modal vs SkyPilot vs RunPods — programmatic remote training comparison (canonical location: `docs/compute/`) |
